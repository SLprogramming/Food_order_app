...
const Banner = () => {
  ...
  return (
    ...
    <div style={backgroundImage} className='w-full md:w-[80%] mx-auto pt-12 pb-12'>
      <div className="flex  text-white w-full flex-col justify-between items-center md:flex-row gap-3 md:gap-0 ">
        ...
        <div className='w-full text-center md:text-left md:w-1/3'>
            ...
            <h1 className='font-[800] text-6xl md:text-7xl text-[var(--color-primary)] lg:text-nowrap'>Home Delivery</h1>
        ...
        <div className='w-full md:w-2/3 '>
            <img className={`${isLoaded?'translate-x-0 opacity-100':'translate-x-full opacity-0'} transition-all duration-700 ease-in-out`} src="/images/slider-courier-mask.png" alt="" />
        </div>
      </div>
      ...
      {icons.map((icon) => {
        return(
          <div key={icon.id} className={`w-full relative px-5 py-5 transition-all duration-200 flex justify-between items-center gap-2 rounded-2xl bg-[#e7dcc8] hover:scale-105 hover:bg-white hover:shadow-2xl`}>
